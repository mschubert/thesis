...
\par\end{centering}
\caption{Volcano plot for pan-cancer associations between pathway scores and mutated driver genes. Effect
...
\end{centering}
\caption{Volcano plots for pan-cancer associations between pathway scores and GISTIC-filtered gene ampli-
...
\end{centering}
\caption{Pan-cancer volcano plots for associations between pathway scores and drug response (IC50). Effect
...
\end{centering}
\caption{Tissue-specific volcano plots for associations between pathway scores and drug response (IC50). Effect
size arbitrary units, p-values FDR-corrected. Pathway-response genes are the only method to recover highly
significant oncogene addiction associations, the rest of methods show no obvious connection between the
drug target and pathway.}
\end{figure}
...
\end{centering}
\caption{Volcano plots for pan-cancer survival associations. Effect size arbitrary units, p-values FDR-
...
\end{centering}
\caption{Volcano plots for tissue-specific survival associations. Effect size arbitrary units, p-values FDR-
